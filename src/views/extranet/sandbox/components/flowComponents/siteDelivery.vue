<template>
  <div class="text-style">
    ...
    <div class="header_contain">
      <img class="header_img" src="@/assets/sandbox/iconHeader.png" alt="" />
      <span class="header_span">站点发货</span>
    </div>
    <div class="common-info-contain-info-other">
...
export default {
  ...
  data() {
    return {
      ...
      activities: [
        {
          content: "站点装箱：站点装箱，箱号BC12345678901234567890",
          timestamp: "",
        },
        {
          content:
            "站点装箱发货：上车扫描，送往分拣中心途中，批次号：R1234567890987654321",
          timestamp: "",
        },
        {
          content:
            "封车：已操作封车，车牌号是津RXF555，承运商是XX市XXXX供应链管理有限公司，封签号是123456789C，987654321C",
          timestamp: "",
        },
      ],
    };
...
::v-deep .el-timeline-item__node {
  width: 12px;
  height: 12px;
  background: linear-gradient(rgba(60, 110, 240, 0.1), rgba(60, 110, 240, 0.1)),
    linear-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255, 1));
  border: 2px solid rgba(60, 110, 240, 0.5);
}
</style>
