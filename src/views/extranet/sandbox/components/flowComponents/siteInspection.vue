<template>
  <div class="text-style">
    ...
    <div class="header_contain">
      <img class="header_img" src="@/assets/sandbox/iconHeader.png" alt="" />
      <span class="header_span">站点验货</span>
    </div>
    <div class="common-info-contain-info-other">
      <p class="common-info-contain-info-other-p">
        解封车：已操作封车，车牌号是津RXF777，承运商是XX市XXXX物流有限公司，封签号是2323232323C
      </p>
      <p class="common-info-contain-info-other-p">
        站点收货：营业部B已解箱收货，包裹JDVA12345678901-1-1-，车次任务号1111111111111
      </p>
      <p class="common-info-contain-info-other-p">
        站点验货：营业部B已解箱收货，包裹JDVA12345678901-1-1-，车次任务号1111111111111
      </p>
    </div>
  </div>
</template>
