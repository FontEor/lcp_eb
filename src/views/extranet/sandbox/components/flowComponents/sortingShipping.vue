<template>
  <div class="text-style">
    ...
    <div class="header_contain">
      <img class="header_img" src="@/assets/sandbox/iconHeader.png" alt="" />
      <span class="header_span">分拣发货</span>
    </div>
    <div class="common-info-contain-info-other">
      <p class="common-info-contain-info-other-p">
        分拣中心分拣：包裹已分拣，装入BC12345678901234567890，等待送往分拣中心B
      </p>
      <p class="common-info-contain-info-other-p">
        分拣中心发货：货物已预发货等待装车，发货批次号1357928-1111-20230710027310444，箱号BC12345678901234567890，等待送往分拣中心B
      </p>
      <p class="common-info-contain-info-other-p">
        封车：已操作封车，车牌号是津RXF666，承运商是XX市XXXX物流有限公司，封签号是2323232323C
      </p>
      <p class="common-info-contain-info-other-p">
        解封车：已操作解封车，车牌号是津RXF666，承运商是XX市XXXX物流有限公司，封签号是2323232323C
      </p>
      <p class="common-info-contain-info-other-p">
        分拣验货：分拣中心B已验货，箱号BC12345678901234567890
      </p>
      <p class="common-info-contain-info-other-p">
        分拣中心分拣：包裹已分拣，装入BC12345678901234567890，等待送往营业部B
      </p>
      <p class="common-info-contain-info-other-p">
        分拣中心发货：货物已预发货等待装车，发货批次号2468029-1111-20230710027310444，箱号BC09876543210987654321，等待送往营业部B
      </p>
      <p class="common-info-contain-info-other-p">
        封车：已操作封车，车牌号是津RXF777，承运商是XX市XXXX物流有限公司，封签号是2323232323C
      </p>
    </div>
  </div>
</template>
