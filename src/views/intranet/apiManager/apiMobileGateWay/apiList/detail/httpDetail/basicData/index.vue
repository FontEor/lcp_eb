      ...
      <el-row class="row--offset">
        ...
        <el-col :span="8">
          <el-form-item label="功能描述" prop="remark">
            <el-input
              v-model.trim="basicInfoData.remark"
              placeholder="请输入功能描述"
              type="textarea"
              :rows="1"
            ></el-input>
...
import CreateGroupDialog from "@/views/intranet/apiManager/apiMobileGateWay/apiList/detail/httpDetail/basicData/createGroupDialog.vue";
...
export default {
  ...
  methods: {
    ...
    //查看分组详情
    gotoGroupDetail(id) {
      const url = `#/apiManager/mobile/apiGroup/detail/${id}`;
