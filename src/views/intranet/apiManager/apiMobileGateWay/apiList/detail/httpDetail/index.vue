...
<script>
import HeaderInfo from "@/views/intranet/apiManager/apiMobileGateWay/apiList/detail/components/HeaderInfo.vue";
import BasicInfo from "@/views/intranet/apiManager/apiMobileGateWay/apiList/detail/httpDetail/basicData/index.vue";
import ApiDoc from "@/views/intranet/apiManager/apiMobileGateWay/apiList/detail/httpDetail/apiDoc/index.vue";
...
export default {
  ...
  methods: {
    ...
    handleClickTab() {
      ...
      const name = "ApiManagerMobileDetail";
      const params = { id };
      const query = { tab };
