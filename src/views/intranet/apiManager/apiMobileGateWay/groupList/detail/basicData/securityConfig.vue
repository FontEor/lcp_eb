...
import SignAuthentication from "@/views/intranet/apiManager/apiMobileGateWay/groupList/detail/basicData/signAuthentication";
import LoginAuthentication from "@/views/intranet/apiManager/apiMobileGateWay/groupList/detail/basicData/loginAuthentication";
