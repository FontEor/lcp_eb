...
import EditClusterDialog from "@/views/intranet/apiManager/clusterList/editClusterDialog.vue";
...
export default {
  ...
  methods: {
    ...
    queryApi() {
      ...
      const sord = "desc";
      const gwParams = [{ page, pageSize, sord, sidx }, { name, sceneType: 1}];
      cloudCluster
