  ...
  <article class="right-document">
    ...
    <div v-else class="right-document__content">
      ...
      <TableDocument
        ...
        title="响应参数"
      />
      <ExampleDocument title="请求报文示例" :demo="requestDemo" />
      <ExampleDocument title="响应报文示例" :demo="responseDemo" />
      <ExampleDocument title="异常示例" :demo="exceptionDemo" />
      <TableDocument
...
export default {
  ...
  props: {
    ...
    requestDemo: { type: String, default: "" },
    responseDemo: { type: String, default: "" },
